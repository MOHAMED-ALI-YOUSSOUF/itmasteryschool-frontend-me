export const config = {
  project: {
    ...
    description:
      "Unlock the Future of Technology at Our IT School: Discover Cutting-Edge Courses, Hands-on Training, and Expert Guidance. Join Today for a Thriving Tech Career!",
    version: "1.0.0",
  },
  contact: {
